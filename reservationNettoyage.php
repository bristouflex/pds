        ...
        <div class="singel_right">
            <div class="labout span_1_of_a1">
                <div class="flexslider">
                    <img class="img-responsive" src="images/nettoyage.png" />
                </div>
            </div>
                ...
                <div class="btn_form button item_add item_1">
                    <form>
                        ...
                        if(checkCotisation() || $_SESSION["user"]->getIsMember() == 0) {
                            echo "<button type=\"button\" class=\"btn btn-secondary btn-lg btn-block\" onclick=\"t4()\">faire nettoyer mon appareil</button>";
                        }else{
