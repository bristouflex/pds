        ...
        <div class="singel_right">
            <div class="labout span_1_of_a1">
                <div class="flexslider">
                    <img class="img-responsive" src="images/avitaillement.jpg" />
                </div>
            </div>
            <div class="cont1 span_2_of_a1 simpleCart_shelfItem">
                ...
                <p> Vous n'avez plus d'essence? Refaites le plein chez nous!</p>

                <div class="btn_form button item_add item_1">
                    <form>
                        <?php
                        if(checkCotisation() || $_SESSION["user"]->getIsMember() == 0) {
                            echo "<button type=\"button\" class=\"btn btn-secondary btn-lg btn-block\" onclick=\"t3()\">faire le plein </button>";
                        }else{
